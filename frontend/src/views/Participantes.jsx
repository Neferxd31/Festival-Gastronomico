        ...
        <div className="part-nav__links">
          ...
          {user ? (
            <div className="part-nav__user">
              ...
              <button onClick={handleLogout} className="part-nav__logout">
                Salir
              </button>
            </div>
          ) : (
            <Link to="/login" className="part-nav__signin">
              Iniciar sesión
            </Link>
          )}
        </div>
            ...
            {filtrados.map(r => (
              <Link to={`/participantes/${r.id}`} key={r.id} className="part-card">
                ...
                <div className="part-card__body">
                  ...
                  {r.plato?.nombre && (
                    <span className="part-card__plato">
                      🍽 {r.plato.nombre}
                    </span>
                  )}
                  ...
                  {/* 🎥 VIDEO EMBEBIDO */}
                  {r.video_url && (
                    <video className="part-card__video" controls>
